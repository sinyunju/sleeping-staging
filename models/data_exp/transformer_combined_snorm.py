...
if __name__ == '__main__':
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(),
                       ...
                       'best_transformer_combined_snorm.pt'))
        else:
            no_improve += 1
    ...
    model.load_state_dict(torch.load(
        os.path.join(RESULTS_PATH, 'best_transformer_combined_snorm.pt'),
        map_location=device))
    ...
    with open(os.path.join(RESULTS_PATH,
              'transformer_combined_snorm.json'), 'w') as f:
        json.dump(results, f, indent=4)
    print("저장 완료: transformer_combined_snorm.json")