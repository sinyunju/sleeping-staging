...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(
        os.path.join(RESULTS_PATH, 'best_cnn1d_combined_snorm.pt'),
        map_location=device))
    ...
    with open(os.path.join(RESULTS_PATH,
              'cnn1d_combined_snorm.json'), 'w') as f:
        json.dump(results, f, indent=4)
    print("저장 완료: cnn1d_combined_snorm.json")