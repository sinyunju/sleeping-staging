...
if __name__ == '__main__':
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(),
                       os.path.join(RESULTS_PATH, 'best_cnn_lstm_combined.pt'))
        else:
            no_improve += 1
    ...
    with open(os.path.join(RESULTS_PATH, 'cnn_lstm_combined.json'), 'w') as f:
        json.dump(results, f, indent=4)
    print("저장 완료: cnn_lstm_combined.json")