...
print(f"\nCNN+LSTM Random Search 시작 (N={N_SEARCH})")
print("="*50)
...
print(f"\n{'='*50}")
print(f"CNN+LSTM Best Val F1: {best_f1:.4f}")
...
with open(os.path.join(GRID_PATH, 'cnn_lstm_search.json'), 'w') as f:
    json.dump(output, f, indent=4)
print("저장 완료: cnn_lstm_search.json")