...
class CNN_LSTM(nn.Module):
    ...
    def __init__(self, n_channels=2, n_classes=5,
        ...
        self.cnn = nn.Sequential(
            ...
            nn.Conv1d(n_channels, 32, kernel_size=50,
                      padding=24, stride=1),
            nn.BatchNorm1d(32),
            nn.ReLU(),
            nn.Dropout(dropout),
...
if __name__ == '__main__':
    ...
    model     = CNN_LSTM(n_channels=2, n_classes=5,
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(),
                       os.path.join(RESULTS_PATH, 'best_cnn_lstm.pt'))
        else:
            no_improve += 1
    ...
    with open(os.path.join(RESULTS_PATH, 'cnn_lstm_results.json'), 'w') as f:
        json.dump(results, f, indent=4)
    print("결과 저장 완료: cnn_lstm_results.json")