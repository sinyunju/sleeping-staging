...
RESULTS_PATH = os.path.expanduser(
    "~/Desktop/sleeping-staging/results/metrics/basic_exp")
...
if __name__ == '__main__':
    ...
    print(f"Params: lr={LR}, dropout={DROPOUT}, d_model={D_MODEL}, "
          f"n_heads={N_HEADS}, n_layers={N_LAYERS}, batch_size={BATCH_SIZE}")
    start = time.time()
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(),
                       os.path.join(RESULTS_PATH, 'best_transformer_final.pt'))
        else:
            no_improve += 1
    ...
    with open(os.path.join(RESULTS_PATH, 'transformer_final.json'), 'w') as f:
        json.dump(results, f, indent=4)
    print("저장 완료: transformer_final.json")