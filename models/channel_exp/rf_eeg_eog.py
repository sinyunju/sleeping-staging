...
X_train = np.load(os.path.join(PROCESSED_PATH, f'X_train_sc_{CHANNEL_CONFIG}.npy'))
y_train = np.load(os.path.join(PROCESSED_PATH, f'y_train_sc_{CHANNEL_CONFIG}.npy'))
X_val   = np.load(os.path.join(PROCESSED_PATH, f'X_val_sc_{CHANNEL_CONFIG}.npy'))
y_val   = np.load(os.path.join(PROCESSED_PATH, f'y_val_sc_{CHANNEL_CONFIG}.npy'))
X_test  = np.load(os.path.join(PROCESSED_PATH, f'X_test_sc_{CHANNEL_CONFIG}.npy'))
y_test  = np.load(os.path.join(PROCESSED_PATH, f'y_test_sc_{CHANNEL_CONFIG}.npy'))
...
with open(os.path.join(RESULTS_PATH,
          f'rf_{CHANNEL_CONFIG}.json'), 'w') as f:
    json.dump(results, f, indent=4)
print(f"\n저장 완료: rf_{CHANNEL_CONFIG}.json")