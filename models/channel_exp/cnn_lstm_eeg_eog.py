...
if __name__ == '__main__':
    ...
    model     = CNN_LSTM(n_channels=N_CHANNELS, n_classes=5,
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save(model.state_dict(),
                       ...
                       f'best_cnn_lstm_{CHANNEL_CONFIG}.pt'))
        else:
            no_improve += 1
    ...
    model.load_state_dict(torch.load(
        os.path.join(RESULTS_PATH, f'best_cnn_lstm_{CHANNEL_CONFIG}.pt'),
        map_location=device))
    ...
    with open(os.path.join(RESULTS_PATH,
              f'cnn_lstm_{CHANNEL_CONFIG}.json'), 'w') as f:
        json.dump(results, f, indent=4)
    print(f"저장 완료: cnn_lstm_{CHANNEL_CONFIG}.json")